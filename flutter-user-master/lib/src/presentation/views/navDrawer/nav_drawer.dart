...
import 'package:tagyourtaxi_driver/src/presentation/views/NavigatorPages/about.dart';
import 'package:tagyourtaxi_driver/src/presentation/views/NavigatorPages/editprofile.dart';
import 'package:tagyourtaxi_driver/src/presentation/views/NavigatorPages/history.dart';
import 'package:tagyourtaxi_driver/src/presentation/views/NavigatorPages/makecomplaint.dart';
import 'package:tagyourtaxi_driver/src/presentation/views/NavigatorPages/selectlanguage.dart';
          ...
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                SizedBox(
                  height: media.width * 0.05 + MediaQuery.of(context).padding.top,
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      //                       style:
                      //                           GoogleFonts.roboto(fontSize: media.width * fourteen, color: buttonText),
                      //                     ),
                      //                   )
                      //           ],
                      //         ),
                      ...
                      InkWell(
                        onTap: () async {
                          var nav = await Navigator.push(context, MaterialPageRoute(builder: (context) => const Sos()));
                          if (nav) {
                            setState(() {});
                          }
                        },
