...
import 'package:tagyourtaxi_driver/pages/login/select_task_screen.dart';
                                ...
                                child: Button(
                                  onTap: () async {
                                    if (otpNumber.length == 6) {
                                      ...
                                      var verify = await verifyNumber(phnumber, otpNumber);
                                      if (verify.isSuccess) {
                                        var d = await verifyUser(phnumber);
                                        navigate(d);
                                      } else {
                                        _error = verify.result.toString();
                                        setState(() {});
                                      }
                                    }
                                    setState(() {
